...
```{r setup, include=FALSE, message=FALSE, warning=FALSE, echo=FALSE, packages}
...
The pH and alcohol also have similar relationship as sulphates and alcohol. Majority of the wines have good rating where alcohol content is higher, and bad rating where alcohol content is lower, eventhough pH is fairly constant in both cases.
...
```{r}
grid.arrange(ggplot(data=wine, aes(x=factor(quality), y=fixed.acidity, fill=quality))+
               ggtitle('Effect of Acidity on Quality')+
               ylab('Fixed Acidity (g/dm^3)')+
               xlab('Quality')+
               geom_boxplot(),
             ggplot(data=wine, aes(x=factor(quality), y=volatile.acidity, fill=quality))+
               ggtitle('Effect of Volatile Acidity on Quality')+
               ylab('Volatile Acidity (g/dm^3)')+
               xlab('Quality')+
               geom_boxplot(),
             ggplot(data=wine, aes(x=factor(quality), y=citric.acid, fill=quality)) +
               ggtitle('Effect of Citric Acid on Quality')+
               ylab('Citric Acid (g/dm^3)')+
               xlab('Quality')+
               geom_boxplot(),
             ggplot(data=wine, aes(x=factor(quality), y=pH, fill=quality))+
